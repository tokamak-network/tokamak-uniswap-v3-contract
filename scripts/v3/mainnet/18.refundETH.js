...
async function main() {
  ...
  try {
    const txArgs = {
      ...
      data: "",
      gasLimit: 600000,
      value: ethers.utils.parseEther("0.00001"),
    };
    const tx = await deployer.sendTransaction(txArgs);
    // const tx = await NonfungiblePositionManagerContract.connect(
    //   deployer
    // ).refundETH();
    await tx.wait();
    console.log(tx);
