...
const autoRouterResponse = {
    "methodParameters": {
        "calldata": "",
        "value": "0x00",
    ...
    "amountDecimals": "10",
    "quote": "11414426952736737",
    "quoteDecimals": "0.011414426952736737",
    "quoteGasAdjusted": "11414350452736737",
    "quoteGasAdjustedDecimals": "0.011414350452736737",
        ...
        [
            {
                ...
                "sqrtRatioX96": "2340586751586463804859455525445",
                "tickCurrent": "67719",
                "amountIn": "6500000000000000000",
                "amountOut": "7419859242474389"
            }
        ],
        [
            {
                ...
                "fee": "3000",
                "liquidity": "10713212008910823741090",
                "sqrtRatioX96": "90676653463080168963869196236",
                "tickCurrent": "2699",
            ...
            },
            {
                ...
                "sqrtRatioX96": "2042372858774944476172638923046",
                "tickCurrent": "64993",
                "amountOut": "3994567710262348"
            }
        ]
    ],
...
async function main() {
  ...
  for(let i = 0; i< route.length; i ++){
    ...
    if(routePath.length > 1){
        ...
        let amountOutMinimum = Math.floor(routePath[routePath.length-1]["amountOut"] * 0.99);
        ...
        let amountOutMinimum = Math.floor(routePath[0]["amountOut"] * 0.99);
        let SwapParams = 
            {
