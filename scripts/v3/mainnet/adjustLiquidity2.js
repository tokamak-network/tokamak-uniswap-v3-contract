...
async function main() {
  ...
  console.log("balanceBeforeTON", balanceBeforeTON.toString());
   ...
   // ===============burn liquidity
   positionInfo = await NonfungiblePositionManagerContract.positions(6);
  console.log(positionInfo);
  console.log(deployer.address);
    if (positionInfo.liquidity > 0) {
      await exitForETH(NonfungiblePositionManagerContract, positionInfo.liquidity, 6, 0, 0, deployer.address, TONAddress)
    }
  ...
  //         token1 = TONAddress;
  //         amount1Desired = ethers.utils.parseEther("2000000000");
  //       } else {
  //         token0 = TONAddress;
  //         amount0Desired = ethers.utils.parseEther("1000000000");
  //         token1 = WETHAddress;
  ...
  // );
    ...
    // //=======================approve
    // let allowanceAmount = ethers.utils.parseEther('1000000000000000000000'); //0 12개 ether
  ...
  // let amountIn = ethers.BigNumber.from("5038033714247530250000");
  //   const params1 =
  //     {
  //       tokenIn: TONAddress,
