...
async function main() {
  ...
  if (TONAddress < TOSAddress) {
    token0 = TONAddress;
    amount0Desired = ethers.utils.parseUnits("35", 27);
    token1 = TOSAddress;
    ...
    token1 = TONAddress;
    amount1Desired = ethers.utils.parseUnits("35", 27);
  }
  await addLiquidity(
    NonfungiblePositionManagerContract,
    poolAddressTOSTON,
...
async function addLiquidity(
  ...
  // );
  const add = false;
  //console.log(sqrtPriceX96, liquidityForAmount1.toString(), amount0Desired.toString());
  ...
  if (poolAddress !== "0x0000000000000000000000000000000000000000") {
    if (
      ...
      if (liquidity.eq(ethers.constants.Zero)) {
        ...
        if (
          token0 === "0x9Ebd5506D76397aD0F247B311d9453606f787751" ||
          token1 === "0x9Ebd5506D76397aD0F247B311d9453606f787751"
        ) {
          const mintData =
