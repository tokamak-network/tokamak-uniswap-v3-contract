...
async function main() {
  ...
  for (let i = 0; i < postionSnapshotLength - 1; i++){
    ...
    if (id1 === id2){
      ...
      if (positionSnapshot1.liquidity !== positionSnapshot2.liquidity && ((positionSnapshot1.withdrawnToken0 === positionSnapshot2.withdrawnToken0 && positionSnapshot1.withdrawnToken1 === positionSnapshot2.withdrawnToken1) || (positionSnapshot1.collectedFeesToken0 === positionSnapshot2.collectedFeesToken0 && positionSnapshot1.collectedFeesToken1 === positionSnapshot2.collectedFeesToken1))){
