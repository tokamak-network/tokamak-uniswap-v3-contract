...
async function main() {
  ...
  console.log("TON balance", (await TONContract.balanceOf(deployer.address)).toString());
  console.log("TOS balance", (await TOSContract.balanceOf(deployer.address)).toString());
  //approve
  ...
  swapArgs = {
    ...
    recipient: "0xB68AA9E398c054da7EBAaA446292f611CA0CD52B",
    deadline: ethers.BigNumber.from("119637448450"),
    amountIn: ethers.BigNumber.from("500000000000000"),
    amountOutMinimum: 0,
    sqrtPriceLimitX96: 0,
  };
