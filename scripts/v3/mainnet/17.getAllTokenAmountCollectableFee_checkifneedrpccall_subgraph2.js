...
async function main() {
  ...
  for (let i = 0; i < postionSnapshotLength - 1; i++){
    ...
    if (id1 === id2){
      ...
      if ( (positionSnapshot1.feeGrowthInside0LastX128 !== positionSnapshot2.feeGrowthInside0LastX128 || positionSnapshot1.feeGrowthInside1LastX128 !== positionSnapshot2.feeGrowthInside1LastX128) && positionSnapshot1.withdrawnToken0 === positionSnapshot2.withdrawnToken0 && positionSnapshot1.withdrawnToken1 === positionSnapshot2.withdrawnToken1){
