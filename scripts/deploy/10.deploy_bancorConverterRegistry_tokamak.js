...
const MulticallArtifact = require("../abis/Multicall.json");
const BancorConverterRegistryArtifact = require("../abis/BancorConverterRegistry.json");
...
async function main() {
  ...
  const BancorConverterRegistry = new hre.ethers.ContractFactory(BancorConverterRegistryArtifact.abi, BancorConverterRegistryArtifact.bytecode, deployer);
  const bancorConverterRegistry = await BancorConverterRegistry.deploy();
  await bancorConverterRegistry.deployed();
  console.log(`BancorConverterRegistry deployed to ${bancorConverterRegistry.address}`);
